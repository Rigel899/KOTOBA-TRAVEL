...
class LoginView:
    ...
    def _build_controls(self):
        ...
        self.primary_btn = ft.ElevatedButton("Entra / Crea account", style=self._btn_style(T.INDIGO_H if T.IS_DARK else T.INDIGO, "#4868A0" if T.IS_DARK else T.INDIGO_H), on_click=self._on_login)
        ...
        self.recover_btn = ft.TextButton("Hai dimenticato la password?", style=ft.ButtonStyle(color=T.GOLD, text_style=ft.TextStyle(font_family=T.FONT_BODY, size=T.FS_SMALL, decoration=ft.TextDecoration.UNDERLINE), mouse_cursor=ft.MouseCursor.CLICK), visible=False, on_click=self._on_show_recovery)
    ...
    def build(self) -> ft.Control:
        ...
        card = ft.Container(
            ...
            shadow=ft.BoxShadow(
                spread_radius=0,
                blur_radius=50, 
                color=ft.Colors.with_opacity(0.35, T.BG_INK),
