"""
ui/yugi/dojo/views/dojo_kana.py – Addestramento Kana (Dojo) con flusso a due step.
...
class DojoKana:
    ...
    def _setup_screen_group(self) -> ft.Control:
        ...
        return ft.Column([
            ft.Row([
                icon_btn(ft.Icons.ARROW_BACK_IOS_NEW_ROUNDED, icon_color=T.TEXT_M, icon_size=14, on_click=lambda e: self._go_back_to_mode()),
