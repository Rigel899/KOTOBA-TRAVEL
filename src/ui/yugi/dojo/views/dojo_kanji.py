...
class DojoKanji:
    ...
    def _show_results(self):
        ...
        screen = ft.Column([
            ...
            ft.Row([
                ft.Button("Riprova pergamena", style=ft.ButtonStyle(bgcolor=T.BG_CARD, color=T.TEXT), on_click=lambda e: self._start_quiz_with_group(self.selected_group)),
                ft.Button("Torna alle scelte", style=ft.ButtonStyle(bgcolor=T.BELT_KANJI, color=T.BG_MAIN), on_click=lambda e: self._go_back_to_mode()),
