"""
ui/yugi/dojo/views/dojo_kanji.py – Addestramento Kanji (Dojo)
...
TOTAL_QUESTIONS = 10
_log = logging.getLogger("kotoba.ui.dojo_kanji")
    ...
    def _show_results(self):
        ...
        if self.questions:
            try:
                ...
                _log.exception("Kanji result tracking failed")
        if pct == 100:
            grade, color = "Perfezione", T.BELT_KANJI
        elif pct >= 80:
            grade, color = "Ottimo lavoro", T.BELT_KANJI
        else:
        ...
        screen = build_quiz_result_view(
            ...
            grade=grade,
            grade_color=color,
            primary_label="Riprova pergamena",
        ...
        try:
            ...
            _log.exception("Kanji achievement notification failed")
