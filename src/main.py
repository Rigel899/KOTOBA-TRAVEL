...
def _apply_app_theme(page: ft.Page) -> None:
    T.apply_theme(T.load_app_theme())
    page.theme_mode = ft.ThemeMode.DARK if T.IS_DARK else ft.ThemeMode.LIGHT
        ...
        return ft.Container(
            ...
            content=ft.Column(
                [
                    ...
                    ft.ElevatedButton(
                        target_label,
                        style=ft.ButtonStyle(bgcolor=T.RED, color=T.TEXT, mouse_cursor=ft.MouseCursor.CLICK),
